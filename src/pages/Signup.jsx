      ...
      <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] w-full max-w-md p-8 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="text-center mb-10">
            ...
            <h1 className="text-3xl font-bold text-gray-800 mb-2 font-serif">Join the Glamour</h1>
            <p className="text-gray-500">Create an account to book your first service!</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-[#FF69B4] to-[#FF1493] hover:from-[#FF1493] hover:to-[#FF69B4] text-white rounded-2xl py-3.5 font-semibold text-lg shadow-lg shadow-pink-200 hover:shadow-pink-300 transition-all transform hover:-translate-y-0.5 active:scale-95 disabled:opacity-70"
            >
